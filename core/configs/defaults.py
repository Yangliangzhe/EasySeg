...
_C.INPUT = CN()
_C.INPUT.SOURCE_INPUT_SIZE_TRAIN = (1280, 720) # potsdam
...
# hyper-parameters
_C.SOLVER.FOCAL_LOSS = 20.0
_C.SOLVER.DICE_LOSS = 1.0
...
# active strategy
_C.ACTIVE.NAME = 'EASE-ADA'
_C.ACTIVE.SETTING = 'PA'
...
_C.INTERACTIVE = CN()
_C.INTERACTIVE.FN_THRESHOLD = 0.25
_C.INTERACTIVE.max_num_next_clicks = 20
_C.INTERACTIVE.POSITIVE_THRESHOLD = 0.05
_C.INTERACTIVE.POSITIVE_LOSS = 0.05
_C.INTERACTIVE.WARMUP_ITER = 2000
_C.INTERACTIVE.POINT_LOSS = 2.0
_C.INTERACTIVE.DOWN_LR = 0.1
_C.INTERACTIVE.select = 'SFAL'
